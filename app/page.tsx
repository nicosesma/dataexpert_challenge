    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#ededed] flex flex-col">
      ...
      <header className="border-b border-white/10 px-8 py-5 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-md bg-rose-600 px-4 py-2 text-sm font-medium text-white transition-all hover:bg-rose-500 disabled:opacity-30 disabled:cursor-not-allowed"
        >
      ...
      {detailStudent && editDraft && (
        ...
        >
          ...
          >
            ...
            {/* Modal footer */}
            <div className="sticky bottom-0 flex items-center justify-end gap-3 border-t border-white/10 bg-[#111] px-6 py-4">
              <button
                onClick={closeDetail}
